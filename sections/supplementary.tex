...
Two cases warrant comment: the Marine \emph{alanine} well contained DL-alanine rather than the L-alanine assayed elsewhere, so that column is a union trait rather than a different one; and the alpha/beta anomers of D-glucose interconvert by mutarotation and were treated as one substrate, whereas methyl glucosides and galactosides lock the anomeric carbon and were not.
...
\caption{
\textbf{Model performance saturates for most phenotypes saturates at 50-100 training samples}.
