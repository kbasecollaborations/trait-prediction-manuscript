...
from scripts.figure7.figure7a_plot import (
    plot_microbe_misclassification_ranking,
    plot_problematic_sample_summary,
)
from scripts.figure7.figure7b_plot import plot_confident_samples_performance
from scripts.figure7.figure7c_plot import plot_precision_recall_scatter
from scripts.figure7.figure7d_plot import plot_balanced_accuracy_scatter
...
def create_figure7(output_file: Path) -> None:
    ...
    ml_df_7b = pd.read_csv(data_dir / "figure7b_confident_ml_results.csv")
    df_7c = pd.read_csv(data_dir / "figure7c_dataset_split_results.csv")
    df_7d = pd.read_csv(data_dir / "figure7d_all_results.csv")
