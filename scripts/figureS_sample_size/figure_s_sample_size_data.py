...
def main() -> None:
    ...
    OUTPUT_DIR = Path("data/outputs/figureS_sample_size")
    ...
    checkpoint_file = (
        OUTPUT_DIR / f"figure_s_sample_size_data_requirements_{FEATURE_TYPE}_checkpoint.csv"
    )
    ...
    # Save results
    results_file = OUTPUT_DIR / f"figure_s_sample_size_data_requirements_{FEATURE_TYPE}.csv"
