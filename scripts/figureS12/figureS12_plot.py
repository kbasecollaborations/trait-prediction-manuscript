#!/usr/bin/env python3
"""
Render Supplementary Figure S12: per-phenotype x per-dataset concordance counts.
...
INPUT_FILE: Final[Path] = Path("data/outputs/figureS12/concordance_counts.tsv")
OUTPUT_FILE: Final[Path] = Path("figures/figure_s12.pdf")
